...
# Internal AF3 stage.
#
# Feature-hiding changes:
# - Requires an inherited anonymous result FD from predict_prismrna_xgb.py.
# - AF3 JSON/output/logs are placed in a mode-700 temporary directory.
# - No ES value is printed.
# - Temporary AF3 files are removed on normal exit, error, INT, TERM, or HUP.
