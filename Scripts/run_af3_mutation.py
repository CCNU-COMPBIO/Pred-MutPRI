...
This helper emits no normal stdout output. It supports an explicit --json_path
so run_af3_all.sh can place the AF3 input inside a mode-700 temporary directory
