...
No interaction CSV, Cytoscape node/edge CSV, network-feature CSV, or feature
JSON is written. Interaction tables and Cytoscape results stay as pandas
DataFrames in memory.

The current formal 30-feature definitions/order are preserved.
"""
